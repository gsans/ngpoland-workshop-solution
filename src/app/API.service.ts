...
export class APIService {
  ...
  OnCreateChattyListener: Observable<
    SubscriptionResponse<OnCreateChattySubscription>
  > = API.graphql(
    graphqlOperation(
  ...
  ) as Observable<SubscriptionResponse<OnCreateChattySubscription>>;

  OnUpdateChattyListener: Observable<
    SubscriptionResponse<OnUpdateChattySubscription>
  > = API.graphql(
    graphqlOperation(
  ...
  ) as Observable<SubscriptionResponse<OnUpdateChattySubscription>>;

  OnDeleteChattyListener: Observable<
    SubscriptionResponse<OnDeleteChattySubscription>
  > = API.graphql(
    graphqlOperation(
  ...
  ) as Observable<SubscriptionResponse<OnDeleteChattySubscription>>;
}
